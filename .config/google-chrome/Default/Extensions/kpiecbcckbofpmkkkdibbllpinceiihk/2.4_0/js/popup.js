...
function updateUI() {
  ...
  if (bkg.settings.premium) {
    $('#premium-account-title').show();
    $('#premium-account-button').show();

    $('#get-premium-title').hide();
    $('#get-premium-button').hide();

    $('.bubbleConnected').hide();
    
    $('#blocked-stat').show();
    $('#premium-text-banner').hide();
  } else {
    $('#get-premium-title').show();
    $('#get-premium-button').show();

    $('#premium-account-title').hide();
    $('#premium-account-button').hide();

    $('.bubbleConnected').show();

    $('#blocked-stat').hide();
    $('#premium-text-banner').show();
  }
...
function renderLocations(continent, el) {
  ...
  if (bkg.settings.premium) {
    ...
    $('.fastestItem .premium').remove();
  } else if (!locations[bkg.settings.location].free) {
    $('.fastestItem .free').remove();
  } else {
    $('.fastestItem .premium').remove();
  }
